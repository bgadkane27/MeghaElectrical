      ...
      <div className="container max-w-7xl mx-auto px-6 py-4">
		...
		//   ref={navRef}
		   className="hidden md:flex items-center space-x-8">
            <a href="#home" className="font-medium transition-colors duration-300">Home</a>
            <a href="#services" className="font-medium transition-colors duration-300">Services</a>
            <a href="#about" className="font-medium transition-colors duration-300">About</a>
            <a href="#contact" className="font-medium transition-colors duration-300">Contact</a>
            <a 
              href="tel:+1234567890" 
