...
const Project = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(".glow-text", {
      textShadow: "0 0 5px rgba(255, 165, 0, 0.8), 0 0 10px rgba(255, 165, 0, 0.4)",
      duration: 3,
      repeat: -1,
      yoyo: true,
      ease: "power2.inOut"
  ...
  return (
    ...
    >
      ...
      {/* <div className="relative z-10 text-center w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-24">
